...
const CashKickCard: React.FC<CashKickCardProps> = ({ cashKickkamount, onClick }) => {
    return (
        <CardContainer>
            <Box >
            ...
            <Stack spacing={1}>
                <Box>
                    <Typography variant="body1" color={theme.palette.text.lowEmphasis}>
                        You have up to{' '}
                        <Typography component="span" variant="body1" color={theme.palette.text.mediumEmphasis} sx={{fontWeight:'bold'}}>
