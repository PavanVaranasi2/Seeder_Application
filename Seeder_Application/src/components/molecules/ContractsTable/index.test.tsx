...
import ContractsTable, { ISeederDataGridProps, customText, customColumn, customChips, customDualText } from './';
...
describe('ContractsTable', () => {
  ...
  it('should render custom header text with specified properties', () => {
    const columns = [
      customColumn({ field: 'col1', headerText: 'Custom Header', valueColor: 'green', width: 150 }),
      { field: 'col2', headerName: 'Column 2', width: 150 },
    ];
  ...
  it('should render custom cell text with specified properties', () => {
    const columns = [
      customColumn({ field: 'col1', headerText: 'Column 1', valueColor: 'blue', marginTop: 10, width: 150 }),
      { field: 'col2', headerName: 'Column 2', width: 150 },
    ];
  ...
  describe('customChips', () => {
    it('renders correctly with provided data', () => {
      ...
      expect(chipText).toHaveStyle(`color: ${theme.palette.text.mediumEmphasis}`);
      expect(chipText.closest('.MuiChip-root')).toHaveStyle(`background-color: ${theme.palette.background.elevation2}`);
    });
  });
  ...
  it('should render custom text with default properties', () => {
    ...
    const textElement = screen.getByText('Test Text');
    expect(textElement).toBeInTheDocument();
    expect(textElement).toHaveStyle(`color: ${theme.palette.text.lowEmphasis}`);
  ...
  it('should render custom column with default props', () => {
    ...
    expect(headerCell).toBeInTheDocument();
    expect(headerCell).toHaveStyle(`color: ${theme.palette.text.lowEmphasis}`);
    expect(dataCell).toBeInTheDocument();
